...
BuildRequires:	ACS-Tools-Kit-Benchmark-devel >= %{version} ACS-acserr-1 >= %{version}
...
ln -s /home/almamgr/ACS-%{version}/ACSSW/lib/libtatlib.tcl/ %{_builddir}/%{name}-%{version}/LGPL/CommonSoftware/baciidl/lib/
