...
echo "CLASSPATH=/usr/share/java/:/usr/local/share/java:/home/almamgr/ACS-%{version}/JacORB/lib/*:/usr/share/java/*:/usr/share/java/*/*" >> %{buildroot}%{_sysconfdir}/profile.d/acscb.sh
