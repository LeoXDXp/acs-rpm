...
echo "CLASSPATH=/usr/share/java/:/usr/local/share/java:/home/almamgr/ACS-%{version}/JacORB/lib:/usr/share/ant/lib:/usr/share/maven/lib" >> %{buildroot}%{_sysconfdir}/profile.d/acscb.sh
